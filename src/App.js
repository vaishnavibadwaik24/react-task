...
function App() {
  ...
  <div className="container flex justify-between h-16 mx-auto items-center">
    ...
    <ul className="items-stretch hidden space-x-3 lg:flex">
      ...
      <li className="flex">
        <a href="#Skills" className="flex items-center px-4 -mb-1">Skills</a>
      </li>
      <li className="flex">
    ...
    <div className="items-center hidden lg:flex space-x-4">
      <a href={resume} target='_blank' className="self-center px-6 py-2 font-semibold rounded dark:bg-white dark:text-black hover:bg-cyan-950 hover:text-white">View CV</a>
      <a href="#Project" className="self-center px-6 py-2 font-semibold rounded dark:bg-white dark:text-black hover:bg-cyan-950 hover:text-white">Projects</a>
    </div>
